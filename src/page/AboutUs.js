    ...
    <section className="">
      ...
      <div className="row  core_activities_sec padding_side pt-5">
        <div className="col-12 col-lg-6  pt-5">
          <img
            src="../../public/assets/image/mobile_pc_chart.png"
            height="auto"
            width="100%"
            alt=""
          />
        ...
        <div className="row pt-5 text-center padding_side">
          <div className="col-12 col-sm-6 col-lg-4   meet_team_hover">
            <div className="container_img mx-auto">
              <img
                src="../../public/assets/image/handsome-bearded-businessman-rubbing-hands-having-deal.jpg"
                height="auto"
                width="100%"
          ...
          <div className="col-12 col-sm-6 col-lg-4   meet_team_hover">
            <div className="container_img mx-auto">
              <img
                src="../../public/assets/image/young-bearded-man-with-striped-shirt.jpg"
                height="auto"
                width="100%"
                className="our_team_img pb-5 image "
                alt=""
          ...
          <div className="col-12 col-sm-6 col-lg-4   rounded-5 meet_team_hover">
            <div className="container_img mx-auto rounded-5">
              <img
                src="../../public/assets/image/young-handsome-man-wearing-casual-tshirt-blue-background-happy-face-smiling-with-crossed-arms-looking-camera-positive-person.jpg"
                height="auto"
                width="100%"
                className="our_team_img pb-5 image "
                alt="" />
